...
void drawLog ()
{
	...
	s_messages.clear ();
#else
	// PORTHAUL: log colors harmonized with the earthy palette (was bright RGB)
	ImVec4 const s_colors[] = {
	    [DEBUG]    = ImGui::ColorConvertU32ToFloat4 (ph::pal::imcol (ph::pal::MOSS)),       // dim
	    [INFO]     = ImGui::ColorConvertU32ToFloat4 (ph::pal::imcol (ph::pal::BONE)),       // text
	    [ERROR]    = ImGui::ColorConvertU32ToFloat4 (ph::pal::imcol (ph::pal::SIGNAL_RED)), // red signal
	    [COMMAND]  = ImGui::ColorConvertU32ToFloat4 (ph::pal::imcol (ph::pal::ACCENT)),     // accent
	    [RESPONSE] = ImGui::ColorConvertU32ToFloat4 (ph::pal::imcol (ph::pal::BONE_DIM)),   // dim text
	};
